...
\input{chapters/chapter03/backend/node-server}

\subsection{Configuración Express}
\input{chapters/chapter03/backend/express-server}

\subsection{Configuración Firebase}
\input{chapters/chapter03/backend/firebase}

\subsection{Integración con Shopify}
\input{chapters/chapter03/backend/shopify}

\subsection{Webhooks}
\input{chapters/chapter03/backend/webhooks}

\subsection{Websockets con Socket.IO}
\input{chapters/chapter03/backend/sockets}
